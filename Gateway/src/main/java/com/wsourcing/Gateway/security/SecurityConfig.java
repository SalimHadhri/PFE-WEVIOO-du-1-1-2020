...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                //accounts
                .antMatchers("/service/accounts/listAccounts").hasAnyRole("MANAGER","USER")
                .antMatchers("/service/accounts/addAccount").hasRole("ADMIN")
                .antMatchers("/service/accounts/deleteAccount/{id}").hasAnyRole("ADMIN","MANAGER")
                ...
                //users
                .antMatchers("/user/users/listUsers").hasRole("USER")
                .antMatchers("/user/users/addUser").permitAll()
                .antMatchers("/user/users/deleteUser/{id}").hasRole("MANAGER")
                .antMatchers("/user/users/updateUser/{id}").hasRole("ADMIN")
                .antMatchers("/user/users/findUser/{id}").hasRole("USER")
                //searches
